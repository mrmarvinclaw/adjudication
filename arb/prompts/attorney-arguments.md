...
Before writing the merits submission, identify the proposition's decisive factual elements and make a serious evidence search for your side. Prefer primary source artifacts over summaries: official records, PDFs, images, API JSON, archived pages, screenshots, transcripts, full videos or clips, and original statements.
...
Include a short evidence-search ledger in your filing or technical_reports when the proposition turns on missing or hard-to-get source material. The ledger should list the decisive source target, a few targeted searches or repositories checked, material found and submitted, material not found, and unresolved gaps. Keep it concise and factual. Do not delay the filing for exhaustive search.
